        ...
        <div className="inner">
          ...
          <section id="banner">
            <div className="content">
              ...
              <p>About five years ago, I founded raimonvibe, a research company in the technology field, to dive deep into programming and push the boundaries of digital innovation. I've explored a wide range of technologies, working with languages like Python, JavaScript, Java, HTML and CSS, and Flutter Dart. Studying both frontend and backend solutions has been fascinating, aiming for seamless and efficient integration. Utilizing powerful frameworks like React, Django, and Node.js, along with database systems such as MongoDB and Mongoose, I've been able to create robust applications.</p>
